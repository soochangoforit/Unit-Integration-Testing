...
class StudentServiceTest {
  ...
  void testDeleteStudent() {
    ...
    /**
     * Method under test: {@link StudentService#updateStudent(Long, Student)}
     */
    @Test
    void testUpdateStudent() {
      when(studentRepository.save((Student) org.mockito.Mockito.any())).thenReturn(new Student());
      when(studentRepository.existsById((Long) org.mockito.Mockito.any())).thenReturn(true);
      studentService.updateStudent(123L, new Student());
    ...
    void testUpdateStudent2() {
      when(studentRepository.save((Student) org.mockito.Mockito.any()))
